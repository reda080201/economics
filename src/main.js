...
"use strict";
    ...
    function runKeynesianModel(inputs, economy) {
    ...
    function runISLMModel(inputs, economy) {
    ...
    function runPhillipsModel(inputs, economy) {
    ...
    function runTaylorRuleModel(inputs, economy) {
